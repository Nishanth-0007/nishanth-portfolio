        ...
        <div className="bg-emerald-500/5 border border-emerald-500/20 p-8 rounded-3xl">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-500">B.Tech in AI & ML (2022-2026)</p>
            </div>
            <div>
              <p className="text-white font-bold">Sri Chaitanya Junior Kala Shala</p>
              <p className="text-xs text-slate-500">Intermediate (MPC) - 2022</p>
            </div>
            <div>
              <p className="text-white font-bold">Atomic Energy Central School-2</p>
              <p className="text-xs text-slate-500">Secondary School Certificate (CBSE) - 2020</p>
            </div>
          </div>
        </div>
      </div>
